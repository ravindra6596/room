...
class PersonalMonths extends StatefulWidget {
  @override
  _PersonalMonthsState createState() => _PersonalMonthsState();
  String getmonth;
  PersonalMonths.withMonth(String selectRoomMonth) {
    getmonth = selectRoomMonth;
  }
}

class _PersonalMonthsState extends State<PersonalMonths> {
  var items;
  var price;
  var name;
  String date = '';
